...
public class MiniRAParser implements MiniRAParserConstants {
  ...
  static final public Operator Operator() throws ParseException {
   ...
   Token n20;
    ...
    case TIMES:
      ...
      break;
    case DIV:
      n10 = jj_consume_token(DIV);
                  n9 = JTBToolkit.makeNodeToken(n10);
        n0 = new NodeChoice(n9, 4);
      break;
    case BITOR:
      n12 = jj_consume_token(BITOR);
                    n11 = JTBToolkit.makeNodeToken(n12);
        n0 = new NodeChoice(n11, 5);
      break;
    case BITAND:
      n14 = jj_consume_token(BITAND);
                     n13 = JTBToolkit.makeNodeToken(n14);
        n0 = new NodeChoice(n13, 6);
      break;
    case LSHIFT:
      n16 = jj_consume_token(LSHIFT);
                     n15 = JTBToolkit.makeNodeToken(n16);
        n0 = new NodeChoice(n15, 7);
      break;
    case RSHIFT:
      n18 = jj_consume_token(RSHIFT);
                     n17 = JTBToolkit.makeNodeToken(n18);
        n0 = new NodeChoice(n17, 8);
      break;
    case BITXOR:
      n20 = jj_consume_token(BITXOR);
  ...
  static {
   ...
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0xfe7c0,0x0,0xfe7c0,0xfe000009,0x1,0xfe000000,0xfe000000,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x1000000,0x1000000,0x1000000,0x0,0x181ffff,0x0,0x181ffff,0x1ffff,};
   }
